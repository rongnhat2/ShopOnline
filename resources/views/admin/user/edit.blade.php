                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="name"  required="" readonly="" value="{{ $user->name }}" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="email"  required="" readonly="" value="{{ $user->email }}" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
